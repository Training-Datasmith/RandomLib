 ...
 * @author     Ben Ramsey <ben@benramsey.com>
 */
class Sodium extends \Random_Lib\Abstract_Source
{
    /**
     ...
     *                           testing purposes
     */
    public function __construct($use_libsodium = true)
    {
        if ($use_libsodium && extension_loaded('libsodium')) {
            $this->has_libsodium = true;
        }
    }
    /**
